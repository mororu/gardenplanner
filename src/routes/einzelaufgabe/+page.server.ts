...
const TITEL_FEHLT = 'Ohne Titel entsteht kein Termin. Schreib in einem Satz, worum es geht.';
 ...
 */
const TERMIN_FEHLT = 'Wähle ein Datum, bis zu dem der Termin erledigt sein soll.';
