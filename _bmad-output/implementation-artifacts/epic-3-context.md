...
- **Die Farbe von `— unbesetzt —` ist entschieden** (2026-08-28) und braucht keine Klärung mehr: ein **eigenes** Token, Ringelblume, bereits im Gestaltungsrahmen deklariert und in beiden Modi gemessen. „Unbesetzt" und „überfällig" sind zwei Aussagen — etwas liegt, gegen: eine Lücke, die jemand schliessen muss — und tragen darum zwei Farben. Im Hellen sind die beiden Töne einander sehr nah; das ist nachgerechnet und hingenommen, weil sie nie auf derselben Seite vorkommen und das Wort ohnehin die Aussage trägt. Story 3.1 benutzt das Token nur noch; die Torregel für unbenutzte Tokens meldet es bis dahin als reserviert.
